...
try {
   ...
   $stmt = $pdo->query("SELECT * FROM peraturan_kos ORDER BY isi_peraturan ASC");
   $rules = $stmt->fetchAll(PDO::FETCH_ASSOC);

   $stmt = $pdo->prepare("SELECT * FROM peraturan_kos ORDER BY isi_peraturan ASC LIMIT :limit OFFSET :offset");
